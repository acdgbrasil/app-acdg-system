...
Packages with other changes:
 ...
 - [`acdg_system` - `v0.1.2`](#acdg_system---v012)
 - [`auth` - `v0.1.2`](#auth---v012)
 - [`core` - `v0.1.2`](#core---v012)
 - [`core_contracts` - `v0.1.0+1`](#core_contracts---v0101)
 - [`design_system` - `v0.1.2`](#design_system---v012)
 - [`network` - `v0.1.2`](#network---v012)
 - [`persistence` - `v0.2.2`](#persistence---v022)
 - [`shared` - `v1.2.0`](#shared---v120)
 - [`social_care` - `v0.1.2`](#social_care---v012)
 - [`social_care_desktop` - `v1.2.0`](#social_care_desktop---v120)
 - [`social_care_web` - `v1.2.0`](#social_care_web---v120)
...
#### `core_contracts` - `v0.1.0+1`

 - **REFACTOR**: 🏗️  extract core_contracts package — BFF AOT compilation (2.3GB → 55MB image). ([8051b13e](https://github.com/acdgbrasil/acdg/commit/8051b13e26cfc0ad3afa771cf7be5366600f84a3))

#### `design_system` - `v0.1.2`
...
#### `social_care_web` - `v1.2.0`

 - **REFACTOR**: 🏗️  extract core_contracts package — BFF AOT compilation (2.3GB → 55MB image). ([8051b13e](https://github.com/acdgbrasil/acdg/commit/8051b13e26cfc0ad3afa771cf7be5366600f84a3))
 - **FIX**: 🗓️  strip time component from birthDate before sending to people-context (YYYY-MM-DD). ([0ca3bea2](https://github.com/acdgbrasil/acdg/commit/0ca3bea2ae7933a138bf5c23cc9d8a9a9ba357c0))
 - **FIX**: 🔐 add project roles and audience scopes to BFF OIDC request. ([27e33fec](https://github.com/acdgbrasil/acdg/commit/27e33fec5439a025e87548388850bca30a4f06af))
 - **FEAT**: 🚀 complete social care missions (People Context, Sentry, UI Extraction). ([90878c35](https://github.com/acdgbrasil/acdg/commit/90878c354bd621af83d34f5847e8cec6fc88bad9))
 - **FEAT**: 🔗 propagate fullName through addFamilyMember chain for people-context registration. ([1f2387d0](https://github.com/acdgbrasil/acdg/commit/1f2387d01cec3244ccebbe2957860b7531a61c53))
 - **FEAT**: 🔗 integrate people-context for canonical PersonId on family member and patient registration. ([a8794605](https://github.com/acdgbrasil/acdg/commit/a879460581f4fa530bde20f137018096a77d066c))
 - **FEAT**(bff): implement shared kernel with VOs, models and contract. ([ceb7023a](https://github.com/acdgbrasil/acdg/commit/ceb7023a25ee7377eadd9c3d11e159138e1c71d8))
