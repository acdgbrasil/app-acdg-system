...
void main() {
  ...
  group('E. Resource exhaustion', () {
    test('Test #38: token > 8KB → 401 BEFORE any parsing or JWKS fetch '
        '(constraint #1, JWT bombing defence)', () async {
    ...
    test('Test #40: roles array with 10000 entries → bounded or 401', () async {
      final hugeRoles = <String, dynamic>{
        for (var i = 0; i < 10000; i++) 'role_$i': {'rid_$i': 'org-id'},
      };
      final token = buildValidJwt(
        payloadOverrides: {kJwtRolesClaim: hugeRoles},
      );
