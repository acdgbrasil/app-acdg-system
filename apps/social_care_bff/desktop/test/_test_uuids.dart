/// Canonical UUID v4 fixtures for tests across the BFF Desktop suite.
///
/// Local copy of `bff/social_care_web/test/_test_uuids.dart` — the canon
/// established in A23 (UUID Path Validation Canon). Constants are
/// identical across the two test suites; do not diverge.
///
...
// ── Person IDs (used by Registry/Care/Protection requests) ────────────
const kPersonUuid = 'c5d6e7f8-a9b0-4123-9ef0-234567890123';
const kPersonUuidAlt = 'd6e7f8a9-b0c1-4234-bef0-345678901234';

// ── Professional IDs (used by Care.registerAppointment) ───────────────
const kProfessionalUuid = 'e7f8a9b0-c1d2-4345-9ef0-456789012345';

// ── Sentinel values for negative testing ──────────────────────────────

/// A canonical NON-UUID string used to verify rejection paths.
