...
/// Pattern 2 — register-style write for governance request.
class CreateLookupRequestUseCase {
  CreateLookupRequestUseCase({
  ...
  Future<Result<StandardIdResponse>> call(
    ...
    final mutation = CreateLookupRequestMutation(
      id: mutationId,
