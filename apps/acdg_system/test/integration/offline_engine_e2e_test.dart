...
void main() {
  ...
  testWidgets('SyncIndicator Integration: Reage a mudanças no SyncEngine', (
    tester,
  ) async {
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
          appBar: AppBar(actions: [SyncIndicator(status: syncEngine.status)]),
    ...
    when(() => syncQueueService.getAllActions()).thenAnswer(
      (_) async => [
        SyncAction()
          ..status = 'PENDING'
