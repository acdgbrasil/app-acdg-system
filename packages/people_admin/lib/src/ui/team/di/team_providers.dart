...
final peopleListViewModelProvider = Provider.autoDispose<PeopleListViewModel>((
  ref,
) {
...
final personDetailViewModelProvider =
    Provider.autoDispose<PersonDetailViewModel>((ref) {
      throw UnimplementedError(
        'personDetailViewModelProvider must be overridden',
      );
    });
