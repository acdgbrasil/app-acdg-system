...
class EducationalStatusPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<EducationalStatusPage> createState() =>
      _EducationalStatusPageState();
}
...
class _EducationalStatusPageState extends ConsumerState<EducationalStatusPage> {
  ...
  void _onSaveStateChanged(EducationalStatusViewModel vm) {
    if (!mounted) return;
  ...
  @override
  void dispose() {
    print('💀 dispose EducationalStatusPage');
    super.dispose();
  }
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Text(
                    EducationalStatusL10n.navFamilies,
                    style: TextStyle(
                      fontFamily: 'Satoshi',
                  ...
                  const SizedBox(width: 24),
                  const Text(
                    EducationalStatusL10n.navRegistration,
                    style: TextStyle(
                      fontFamily: 'Satoshi',
                      fontWeight: FontWeight.w700,
                      fontSize: 14,
            ...
            ListenableBuilder(
              ...
              builder: (context, _) => Padding(
                ...
                child: Column(
                  ...
                  children: [
                    const Text(
                      EducationalStatusL10n.pageTitle,
                      style: TextStyle(
                        fontFamily: 'Satoshi',
                        fontWeight: FontWeight.w700,
                        fontSize: 38,
                    ...
                    TextButton(
                      ...
                      child: const Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: 7),
                          Text(
                            EducationalStatusL10n.btnCancel,
                            style: TextStyle(
