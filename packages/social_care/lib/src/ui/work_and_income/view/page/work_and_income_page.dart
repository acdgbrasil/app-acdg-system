...
class _WorkAndIncomePageState extends ConsumerState<WorkAndIncomePage> {
  ...
  void _onSaveStateChanged(WorkAndIncomeViewModel vm) {
    if (!mounted) return;
  ...
  @override
  void dispose() {
    print('💀 dispose WorkAndIncomePage');
    super.dispose();
  }
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  const SizedBox(width: 24),
                  const Text(
                    WorkAndIncomeL10n.navRegistration,
                    style: TextStyle(
                      fontFamily: 'Satoshi',
                      fontWeight: FontWeight.w700,
                      fontSize: 14,
