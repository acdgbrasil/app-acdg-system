...
class RegistrationToast extends StatefulWidget {
  ...
  @override
  State<RegistrationToast> createState() => _RegistrationToastState();
}

class _RegistrationToastState extends State<RegistrationToast> {
  @override
