...
class CommunitySupportPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<CommunitySupportPage> createState() =>
      _CommunitySupportPageState();
}

class _CommunitySupportPageState extends ConsumerState<CommunitySupportPage> {
  @override
  void initState() {
    super.initState();
    print(
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Text(
                    CommunitySupportL10n.navFamilies,
                    style: TextStyle(
                      fontFamily: 'Satoshi',
                  ...
                  const SizedBox(width: 24),
                  const Text(
                    CommunitySupportL10n.navRegistration,
                    style: TextStyle(
                      fontFamily: 'Satoshi',
                      fontWeight: FontWeight.w700,
                      fontSize: 14,
            ...
            ListenableBuilder(
              ...
              builder: (context, _) => Padding(
                ...
                child: Column(
                  ...
                  children: [
                    const Text(
                      CommunitySupportL10n.pageTitle,
                      style: TextStyle(
                        fontFamily: 'Satoshi',
                        fontWeight: FontWeight.w700,
                        fontSize: 38,
