  ...
  group('Home Module Arch TDD (Mission 009.1)', () {
    ...
    test('Home components should NOT use hardcoded Colors', () {
      ...
      for (final file in files) {
        ...
        expect(
          ...
          isFalse,
          reason:
              'Hardcoded Color found in ${file.path}. The Home module MUST use AppColors from the design_system.',
        );
      }
    });
    ...
    test('HomePage should NOT use Provider legacy methods', () {
      ...
      expect(
        ...
        isFalse,
        reason:
            'Legacy Provider usage detected in home_page.dart. MUST use ConsumerStatefulWidget and ref.watch/read.',
      );
      expect(
    ...
    test('HomePage should NOT use setState for business logic (Search/Tabs)', () {
      ...
      expect(
        ...
        isFalse,
        reason:
            'Empty setState found in home_page.dart. This is a hack to force rebuilds. Use ListenableBuilder and ViewModel state.',
      );
      expect(
        content.contains(RegExp(r'setState\(\(\) => _activeTab')),
        isFalse,
        reason:
            'Local state _activeTab found in View. Move tab state to HomeViewModel.',
      );
    });
  });
}
