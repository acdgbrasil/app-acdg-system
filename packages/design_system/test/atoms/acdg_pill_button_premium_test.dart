...
void main() {
  group('AcdgPillButton Premium UI Specs', () {
    testWidgets('Desktop button should have multi-layered shadows', (tester) async {
    ...
    testWidgets('Button should show glow effect on Hover (Desktop)', (tester) async {
      tester.view.physicalSize = const Size(1920, 1080);
      tester.view.devicePixelRatio = 1.0;
      ...
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: Center(
              child: AcdgPillButton(onPressed: () {}, label: 'Interactive Button'),
            ),
          ),
        ),
      );
