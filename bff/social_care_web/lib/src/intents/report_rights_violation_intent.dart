...
final class ReportRightsViolationIntent with Equatable {
  ...
  ///
  /// Enforces the 3 required fields (`victimId`, `violationType`,
  /// `descriptionOfFact`) as non-empty strings. Optional fields
  /// (`violationTypeId`, `reportDate`, `incidentDate`, `actionsTaken`) are
  /// carried through verbatim when present; missing values degrade to
  /// `null`. Missing required fields produce a [Failure] whose message
