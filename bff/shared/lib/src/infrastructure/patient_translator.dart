...
class PatientTranslator {
  ...
  static Map<String, dynamic> toJson(Patient p) => {
    ...
    'address': p.address == null
        ? null
        : RegistryMapper.addressToJson(p.address!),
    'familyMembers': p.familyMembers
        .map(RegistryMapper.familyMemberToJson)
        .toList(),
    'initialDiagnoses': p.diagnoses
        .map(RegistryMapper.diagnosisToJson)
        .toList(),
    ...
    'communitySupportNetwork': p.communitySupportNetwork == null
        ? null
        : AssessmentMapper.communitySupportToJson(p.communitySupportNetwork!),
    'socialHealthSummary': p.socialHealthSummary == null
        ? null
        : AssessmentMapper.socialHealthSummaryToJson(p.socialHealthSummary!),
    'appointments': p.appointments.map(CareMapper.appointmentToJson).toList(),
    ...
    'violationReports': p.violationReports
        ...
        .toList(),
    'referrals': p.referrals.map(ProtectionMapper.referralToJson).toList(),
  };
  ...
  static Result<Patient> toDomain(PatientRemote dto) {
    ...
    switch (PatientId.create(dto.patientId)) {
      ...
      case Failure(:final error):
        return Failure('patient.patientId: $error');
    }
    ...
    switch (PersonId.create(dto.personId)) {
      case Success(:final value):
        personId = value;
      case Failure(:final error):
        return Failure('patient.personId: $error');
    }

    final LookupId prRelationshipId;
    switch (LookupId.create(dto.prRelationshipId ?? _defaultPrRelationshipId)) {
      case Success(:final value):
        prRelationshipId = value;
      case Failure(:final error):
        return Failure('patient.prRelationshipId: $error');
    }

    final PersonalData? personalData;
    switch (optionalFromJson(
      dto.personalData,
      RegistryMapper.personalDataFromJson,
    )) {
      case Success(:final value):
        personalData = value;
      case Failure(:final error):
    ...
    switch (optionalFromJson(
      dto.civilDocuments,
      RegistryMapper.civilDocumentsFromJson,
    )) {
      case Success(:final value):
        civilDocuments = value;
      case Failure(:final error):
        return Failure(error);
    }
    ...
    switch (listFromJson(
      dto.familyMembers,
      RegistryMapper.familyMemberFromJson,
      field: 'patient.familyMembers',
    )) {
      case Success(:final value):
        familyMembers = value;
      case Failure(:final error):
    ...
    switch (listFromJson(
      dto.diagnoses,
      RegistryMapper.diagnosisFromJson,
      field: 'patient.diagnoses',
    )) {
      case Success(:final value):
        diagnoses = value;
      case Failure(:final error):
    ...
    switch (optionalFromJson(
      dto.socialIdentity,
      RegistryMapper.socialIdentityFromJson,
    )) {
      case Success(:final value):
    ...
    switch (optionalFromJson(
      dto.housingCondition,
      AssessmentMapper.housingConditionFromJson,
    )) {
      case Success(:final value):
        housingCondition = value;
      case Failure(:final error):
        return Failure(error);
    }
    ...
    switch (optionalFromJson(
      dto.socioeconomicSituation,
      AssessmentMapper.socioEconomicFromJson,
    )) {
      case Success(:final value):
        socioeconomicSituation = value;
      case Failure(:final error):
        return Failure(error);
    }
    ...
    switch (optionalFromJson(
      dto.workAndIncome,
      AssessmentMapper.workAndIncomeFromJson,
    )) {
      case Success(:final value):
        workAndIncome = value;
      case Failure(:final error):
    ...
    switch (optionalFromJson(
      dto.educationalStatus,
      AssessmentMapper.educationalStatusFromJson,
    )) {
      case Success(:final value):
    ...
    switch (optionalFromJson(
      dto.healthStatus,
      AssessmentMapper.healthStatusFromJson,
    )) {
      case Success(:final value):
        healthStatus = value;
      case Failure(:final error):
    ...
    switch (optionalFromJson(
      dto.communitySupportNetwork,
      AssessmentMapper.communitySupportFromJson,
    )) {
      case Success(:final value):
        communitySupportNetwork = value;
      case Failure(:final error):
        return Failure(error);
    }
    ...
    switch (optionalFromJson(
      dto.socialHealthSummary,
      AssessmentMapper.socialHealthSummaryFromJson,
    )) {
      case Success(:final value):
        socialHealthSummary = value;
      case Failure(:final error):
        return Failure(error);
    }
    ...
    switch (listFromJson(
      dto.appointments,
      CareMapper.appointmentFromJson,
      field: 'patient.appointments',
    )) {
      case Success(:final value):
        appointments = value;
      case Failure(:final error):
    ...
    switch (optionalFromJson(
      dto.placementHistory,
      ProtectionMapper.placementHistoryFromJson,
    )) {
      case Success(:final value):
    ...
    switch (listFromJson(
      dto.violationReports,
      ProtectionMapper.violationReportFromJson,
      field: 'patient.violationReports',
    )) {
      case Success(:final value):
    ...
    switch (listFromJson(
      dto.referrals,
      ProtectionMapper.referralFromJson,
      field: 'patient.referrals',
    )) {
      case Success(:final value):
        referrals = value;
      case Failure(:final error):
  ...
  static Result<CivilDocuments> civilDocumentsFromJson(
  ...
  static Result<SocialIdentity> socialIdentityFromJson(
    Map<String, dynamic> j,
