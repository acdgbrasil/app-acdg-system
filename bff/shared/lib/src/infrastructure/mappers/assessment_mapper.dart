...
abstract final class AssessmentMapper {
  ...
  static Map<String, dynamic> socioEconomicToJson(SocioEconomicSituation s) =>
      {
        ...
        'socialBenefits':
            s.socialBenefits.items.map(socialBenefitToJson).toList(),
      };
  ...
  static Result<HousingCondition> housingConditionFromJson(
    ...
    switch (enumFromJson(ConditionType.values, j['type'], 'housingCondition.type')) {
      case Success(:final value): type = value;
      case Failure(:final error): return Failure(error);
    }
    final WallMaterial wallMaterial;
    switch (enumFromJson(WallMaterial.values, j['wallMaterial'], 'housingCondition.wallMaterial')) {
      case Success(:final value): wallMaterial = value;
      case Failure(:final error): return Failure(error);
    }
    final WaterSupply waterSupply;
    switch (enumFromJson(WaterSupply.values, j['waterSupply'], 'housingCondition.waterSupply')) {
      case Success(:final value): waterSupply = value;
      case Failure(:final error): return Failure(error);
    }
    final ElectricityAccess electricityAccess;
    switch (enumFromJson(ElectricityAccess.values, j['electricityAccess'], 'housingCondition.electricityAccess')) {
      case Success(:final value): electricityAccess = value;
      case Failure(:final error): return Failure(error);
    }
    final SewageDisposal sewageDisposal;
    switch (enumFromJson(SewageDisposal.values, j['sewageDisposal'], 'housingCondition.sewageDisposal')) {
      case Success(:final value): sewageDisposal = value;
      case Failure(:final error): return Failure(error);
    }
    final WasteCollection wasteCollection;
    switch (enumFromJson(WasteCollection.values, j['wasteCollection'], 'housingCondition.wasteCollection')) {
      case Success(:final value): wasteCollection = value;
      case Failure(:final error): return Failure(error);
    }
    final AccessibilityLevel accessibilityLevel;
    switch (enumFromJson(AccessibilityLevel.values, j['accessibilityLevel'], 'housingCondition.accessibilityLevel')) {
      case Success(:final value): accessibilityLevel = value;
      case Failure(:final error): return Failure(error);
    }
  ...
  static Result<SocialBenefit> socialBenefitFromJson(Map<String, dynamic> j) {
    ...
    if (j['deceasedCpf'] != null) {
      switch (Cpf.create(j['deceasedCpf'])) {
        case Success(:final value): deceasedCpf = value;
        case Failure(:final error):
  ...
  static Result<SocioEconomicSituation> socioEconomicFromJson(
    ...
    switch (listFromJson(j['socialBenefits'], socialBenefitFromJson,
        field: 'socioEconomic.socialBenefits')) {
      case Success(:final value): benefits = value;
      case Failure(:final error): return Failure(error);
    }

    final SocialBenefitsCollection collection;
    switch (SocialBenefitsCollection.create(benefits)) {
      case Success(:final value): collection = value;
      case Failure(:final error):
  ...
  static Result<WorkAndIncome> workAndIncomeFromJson(Map<String, dynamic> j) {
    ...
    for (final (i, item) in ((j['individualIncomes'] as List?) ?? []).indexed) {
      ...
      switch (PersonId.create(m['memberId'])) {
        ...
        case Failure(:final error):
          return Failure('workAndIncome.individualIncomes[$i].memberId: $error');
      }
      ...
      switch (LookupId.create(m['occupationId'])) {
        ...
        case Failure(:final error):
          return Failure('workAndIncome.individualIncomes[$i].occupationId: $error');
      }
  ...
  static Result<EducationalStatus> educationalStatusFromJson(
    ...
    for (final (i, p) in ((j['memberProfiles'] as List?) ?? []).indexed) {
      ...
      switch (PersonId.create(m['memberId'])) {
        case Success(:final value): memberId = value;
        case Failure(:final error):
          return Failure('educationalStatus.memberProfiles[$i].memberId: $error');
      }
      ...
      switch (LookupId.create(m['educationLevelId'])) {
        ...
        case Failure(:final error):
          return Failure('educationalStatus.memberProfiles[$i].educationLevelId: $error');
      }
    ...
    for (final (i, o) in ((j['programOccurrences'] as List?) ?? []).indexed) {
      ...
      switch (PersonId.create(m['memberId'])) {
        case Success(:final value): memberId = value;
        case Failure(:final error):
          return Failure('educationalStatus.programOccurrences[$i].memberId: $error');
      }
      ...
      switch (TimeStamp.fromIso(m['date'])) {
        ...
        case Failure(:final error):
          return Failure('educationalStatus.programOccurrences[$i].date: $error');
      }
      ...
      switch (LookupId.create(m['effectId'])) {
        ...
        case Failure(:final error):
          return Failure('educationalStatus.programOccurrences[$i].effectId: $error');
      }
    ...
    return Success(EducationalStatus(
      familyId: familyId,
  ...
  static Result<HealthStatus> healthStatusFromJson(Map<String, dynamic> j) {
    ...
    for (final (i, d) in ((j['deficiencies'] as List?) ?? []).indexed) {
      ...
      switch (LookupId.create(m['deficiencyTypeId'])) {
        ...
        case Failure(:final error):
          return Failure('healthStatus.deficiencies[$i].deficiencyTypeId: $error');
      }
