...
/// Pattern 2 — body-less patient-aggregate write. Mutation payload is
/// `{}`; only the path id rides on the URL.
class AdmitPatientUseCase {
  ...
  Future<Result<void>> call(String patientId) async {
    ...
    switch (cachedResult) {
      ...
      case Success(:final value):
        ...
        final mutation = AdmitPatientMutation(
          id: _uuid.v4(),
