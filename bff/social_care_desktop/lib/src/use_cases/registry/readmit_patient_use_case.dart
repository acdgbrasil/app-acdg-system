...
class ReadmitPatientUseCase {
  ReadmitPatientUseCase({
  ...
  Future<Result<void>> call(String patientId, ReadmitPatientRequest req) async {
    ...
    switch (cachedResult) {
      ...
      case Success(:final value):
        ...
        final mutation = ReadmitPatientMutation(
          id: _uuid.v4(),
