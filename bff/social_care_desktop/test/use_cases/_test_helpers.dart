...
class TestContext {
  ...
  static TestContext fresh({DateTime? now}) {
    ...
    return TestContext._(
      cacheDb: cacheDb,
      syncDb: syncDb,
      patientsCache: DriftPatientsCache(cacheDb, clock: fakeClock),
      careCache: DriftCareCache(cacheDb, clock: fakeClock),
      protectionCache: DriftProtectionCache(cacheDb, clock: fakeClock),
      auditCache: DriftAuditCache(cacheDb, clock: fakeClock),
      lookupCache: DriftLookupCache(cacheDb, clock: fakeClock),
